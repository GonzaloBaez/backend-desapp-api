...
sonarqube {
	properties {
		...
		property ("sonar.exclusions","**/securityConfig/*, **/dto/*, **/cache/*, **/swagger/*, **/aspects/*, " +
				"**/JwtAuthenticationController.kt, **/JwtUserDetailsService.kt, **/GlobalExceptionHandler.kt, **/InitServiceInMemory.kt")
	}
}
jacoco {
	toolVersion = "0.8.7"
